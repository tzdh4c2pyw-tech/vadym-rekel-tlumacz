...
export const metadata: Metadata = {
  ...
  description:
    "Tłumacz przysięgły języka ukraińskiego Toruniu: tłumaczenia dokumentów do sądu, urzędu, Policji, prokuratury, uczelni i pracodawcy. Obsługa online i wysyłka.",
  alternates: {
