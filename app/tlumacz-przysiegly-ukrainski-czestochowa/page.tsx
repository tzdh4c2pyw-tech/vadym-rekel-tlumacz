...
export const metadata: Metadata = {
  ...
  description:
    "Tłumacz przysięgły języka ukraińskiego Częstochowie: tłumaczenia dokumentów do sądu, urzędu, Policji, prokuratury, uczelni i pracodawcy. Obsługa online i wysyłka.",
  alternates: {
  ...
  openGraph: {
    ...
    url: "https://vadym-rekel-tlumacz.vercel.app/tlumacz-przysiegly-ukrainski-czestochowa",
    type: "website",
  },
};
