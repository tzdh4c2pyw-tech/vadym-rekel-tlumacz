...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Tłumacz przysięgły ukraiński Olsztyn | Vadym Rekel",
    description:
      "Tłumaczenia przysięgłe z języka ukraińskiego na polski i z polskiego na ukraiński dla osób z miasta Olsztyn. Dokumenty urzędowe, sądowe i prywatne.",
    url: "https://vadym-rekel-tlumacz.vercel.app/tlumacz-przysiegly-ukrainski-olsztyn",
    type: "website",
  },
};

const city = "Olsztyn";
const cityLoc = "Olsztynie";
    ...
    <main className="city-page">
      <section className="city-hero">
        <div className="city-container">
          ...
          <h1>Tłumacz przysięgły ukraiński Olsztyn — dokumenty, sąd, urząd</h1>

          <p className="city-lead">
            Potrzebujesz tłumaczenia przysięgłego z języka ukraińskiego na polski
            albo z polskiego na ukraiński Olsztynie? Przyjmuję dokumenty online,
      ...
      <section className="city-section city-section-alt">
        <div className="city-container city-narrow">
          <h2>Jak działa tłumaczenie przysięgłe dla osób z miasta Olsztyn?</h2>
      ...
      <section className="city-section">
        <div className="city-container">
          <h2>Najczęstsze tłumaczenia z języka ukraińskiego Olsztynie</h2>
      ...
      <section className="city-cta">
        <div className="city-container">
          <h2>Potrzebujesz tłumacza przysięgłego ukraińskiego Olsztynie?</h2>
          <p>
