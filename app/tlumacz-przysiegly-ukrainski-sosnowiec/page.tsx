...
export const metadata: Metadata = {
  title: "Tłumacz przysięgły ukraiński Sosnowiec | Tłumaczenia dokumentów",
  description:
    "Tłumacz przysięgły języka ukraińskiego Sosnowcu: tłumaczenia dokumentów do sądu, urzędu, Policji, prokuratury, uczelni i pracodawcy. Kancelaria mieści się w Krakowie. Dokumenty do wstępnej wyceny można przesłać elektronicznie z całej Polski. Obsługa online i wysyłka.",
  alternates: {
    canonical: "/tlumacz-przysiegly-ukrainski-sosnowiec",
  },
  openGraph: {
    title: "Tłumacz przysięgły ukraiński Sosnowiec | Vadym Rekel",
    description:
      "Tłumaczenia przysięgłe z języka ukraińskiego na polski i z polskiego na ukraiński dla osób z miasta Sosnowiec. Dokumenty urzędowe, sądowe i prywatne.",
    url: "https://vadymrekel.pro/tlumacz-przysiegly-ukrainski-sosnowiec",
    type: "website",
  },
};

const city = "Sosnowiec";
const cityLoc = "Sosnowcu";
    ...
    <main className="city-page">
      <section className="city-hero">
        <div className="city-container">
          ...
          <h1>Tłumacz przysięgły ukraiński Sosnowiec — dokumenty, sąd, urząd</h1>

          <p className="city-lead">
            Potrzebujesz tłumaczenia przysięgłego z języka ukraińskiego na polski
            albo z polskiego na ukraiński Sosnowcu? Przyjmuję dokumenty online,
      ...
      <section className="city-section city-section-alt">
        <div className="city-container city-narrow">
          <h2>Jak działa tłumaczenie przysięgłe dla osób z miasta Sosnowiec?</h2>
      ...
      <section className="city-section">
        <div className="city-container">
          <h2>Najczęstsze tłumaczenia z języka ukraińskiego Sosnowcu</h2>
      ...
      <section className="city-cta">
        <div className="city-container">
          <h2>Potrzebujesz tłumacza przysięgłego ukraińskiego Sosnowcu?</h2>
          <p>
